...
class Block extends Position implements Metadatable{
	...
	const BED_BLOCK = 26;
	const POWERED_RAIL = 27, GOLDEN_RAIL = 27;
	...
	const COCOA_BLOCK = 127, COCOA_PODS = 127, COCOA = 127;
	...
	const DOUBLE_RED_SANDSTONE_SLAB = 181, DOUBLE_PURPUR_SLAB = 181, DOUBLE_SLAB2 = 181;
	const RED_SANDSTONE_SLAB = 182, PURPUR_SLAB = 182, SLAB2 = 182;
	...
	const PURPUR = 201, PURPUR_BLOCK = 201;
    ...
    const CAMERA_BLOCK = 242;
	const PODZOL = 243;
	const BEETROOT_BLOCK = 244;
	const STONECUTTER = 245;
	const GLOWINGOBSIDIAN = 246, GLOWING_OBSIDIAN = 246;
 	const NETHERREACTOR = 247, NETHER_REACTOR = 247;
 	const INFO_UPDATE = 248, UPDATE_BLOCK = 248;
 	const INFO_UPDATE2 = 249, ATEUPD_BLOCK = 249;
 	const MOVING_BLOCK = 250, MOVINGBLOCK = 250, BLOCK_MOVED_BY_PISTON = 250;
	const OBSERVER = 251;
	const INFO_RESERVED6 = 255, RESERVED6 = 255;
